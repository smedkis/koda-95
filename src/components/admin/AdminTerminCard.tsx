    ...
    <Box className="flex flex-col bg-white">
      ...
      {showActions ? (
        <Link
          ...
          className={cn(
            "mt-6 inline-flex w-full cursor-pointer items-center justify-center gap-2 rounded bg-secondary px-[14px] py-[10px] font-body text-[16px] font-medium text-paragraph transition-colors hover:bg-black hover:text-white",
          )}
        >
          Odpri
        </Link>
